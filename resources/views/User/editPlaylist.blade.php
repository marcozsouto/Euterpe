...
<link rel="stylesheet" href="{{ asset('css/FormPlaylist.css') }}">
    ...
    <body>
        ...
        <form action="{{route('user.playlist.edit.do')}}" method='post' enctype="multipart/form-data" id="form-edit-playlist">
        ...
        <a href="/home/playlist/delete/{{$playlist->id}}" class="remove-playlist">Delete</a>
        </div>
